                ...
                <div className="sm:flex justify-center items-center">
                    ...
                    <div>
                        ...
                        <form onSubmit={handleForm}>
                            ...
                            <button className="bg-blue-500 btn rounded-full btn-secondary w-full ring-2 ring-blue-500">
                                Login
                            </button>
                        </form>
                    <p className="mt-4">
                        Don't have an account? 
                        <Link to='/signup' className="mx-2 text-info text-black font-semibold">Signup</Link>
                    </p>
                    </div>
                </div>
            </div>
