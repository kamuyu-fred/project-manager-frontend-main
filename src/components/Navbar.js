...
const Navbar = ({loggedIn, setLoggedIn}) => {
    ...
    return ( 
        <>
            <nav className='lg:px-48 md:px-32 px-8 md:py-6 py-4 top-0 left-0 sticky z-[100] bg-blue-800 opacity-100 shadow-xl'>
                        ...
                        <ul className="md:flex items-center md:text-lg font-large">
                            ...
                            </li>
                            {
                                ...
                                <li className='flex flex-row md:my-0 my-4' onClick={() => setOpen((prev) => !prev)}>
                                    <Link to='/login' className="mx-4 my-4 bg-sky-800 px-3 py-1 hover:bg-sky-800 hover:text-white duration-500 rounded-md" href='https://learn.vabrisetech.co.ke/'>
                                        Login
                                    </Link>
                                    <Link to='/signup' className="mx-4 my-4 bg-sky-800 px-3 py-1 hover:bg-sky-800  hover:text-white hover:text-sky-800 duration-500 rounded-md" href='https://learn.vabrisetech.co.ke/'>
                                        Register
                                    </Link>
                                </li> :
                                <>
